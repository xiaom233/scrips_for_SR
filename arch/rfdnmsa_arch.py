...
class RFDB(nn.Module):
    def __init__(self, in_channels, out_channels, distillation_rate=0.25, conv=nn.Conv2d, num_groups=5, p=0.25):
        ...
        self.esa = ESA(in_channels // self.num_groups, conv)
    ...
    def forward(self, input):
        ...
        # Groupped ESA
        b, c, h, w = out.shape
        out = out.reshape(b * self.num_groups, -1, h, w)
        out_fused = self.esa(out)
        out_fused = out_fused.reshape(b, -1, h, w)
