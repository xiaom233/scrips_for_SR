...
class CoordAtt(nn.Module):
    def __init__(self, inp, oup, reduction=25):
        super(CoordAtt, self).__init__()
        self.pool_h = nn.AdaptiveAvgPool2d((256, 1))
        self.pool_w = nn.AdaptiveAvgPool2d((1, 256))
...
class RFDB(nn.Module):
    def __init__(self, in_channels, out_channels, distillation_rate=0.25, conv=nn.Conv2d, p=0.25):
        ...
        self.coa = CoordAtt(in_channels, in_channels)
